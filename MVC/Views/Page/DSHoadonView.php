...
<form method="post" action="http://localhost/QLKT_MVC/DSHoadon/Timkiem">
					...
					<div class="content__duoi">
						<div class="content__duoi-menu">
							<ul class="content__duoi-list">
								...
								<li class="content__duoi-item"><a href="http://localhost/QLKT_MVC/ThemHoadon" class="content__duoi-link"><i class="content__duoi-link-icon icon__add fa-solid fa-circle-plus"></i>Thanh toán dịch vụ </a></li>
							</ul>
						</div>
								...
								<table border="1" cellspacing="0px" class="bang__quanly">
									...
									?>
										<tr>
											...
											<td><a style="text-decoration: none;" href="http://localhost/QLKT_MVC/DSHoadon/suahoadon/<?php echo $row['Mahd'] ?>"  <?php if($row['Thanhtien']== $row['Tiengiam']) echo 'hidden' ?>>
											...
											<td>
												...
												<a style="text-decoration: none;" href="http://localhost/QLKT_MVC/DSHoadon/Xoahoadon/<?php echo $row['Mahd'] ?>">
