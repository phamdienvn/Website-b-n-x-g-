<?php 
    class ThanhtoanHoadonphong extends controller{
        public $hd;
        ...
        public function Getdata(){
            ...
            $this->view('TrangchuLogin',['page'=>'ThanhtoanHoadonphongView',
        ...
        //          }
        //           else{
        //             $kq=$this->hd->Hoadon_ins($mahd,$map,$nl,$sd,$sn,$m,$ttien,$tongt,$tt);
        //             if($kq){
        //                 $this->view('TrangchuLogin',[
        //                     'page'=>'ThemHoadonView',
        //                     'kq'=>$this->hd->phong_all(),
